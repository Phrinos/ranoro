  ...
  async (request, response) => {
    ...
    try {
      ...
      servicesSnapshot.forEach((doc) => {
        ...
        if (techId !== undefined && techId !== serviceData.technicianId) { updatePayload.technicianId = techId ?? null; needsUpdate = true; }
        if (techName !== undefined && techName !== serviceData.technicianName) { updatePayload.technicianName = techName ?? null; needsUpdate = true; }
