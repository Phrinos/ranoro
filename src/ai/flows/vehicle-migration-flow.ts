...
4.  **Clean and Format Data**:
    ...
    *   **CRITICAL: YEAR FIELD:** If the cell for the year contains a numerical value (e.g., 2020, "2019.0", "'2021"), you MUST extract that number for the 'year' field. Only default to 0 if the cell is completely empty or genuinely non-numeric.
