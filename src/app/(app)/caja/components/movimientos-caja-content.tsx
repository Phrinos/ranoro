...
export function MovimientosCajaContent({ allCashTransactions, allSales, allServices }: MovimientosCajaContentProps) {
  ...
  // Combine all sources into a single transaction list
  const unifiedTransactions = useMemo(() => {
    ...
    // Filter manual transactions to avoid duplicating the ones automatically generated by sales/services
    const manualTransactions = allCashTransactions.filter(t => !t.relatedType);

    return [...saleTransactions, ...serviceTransactions, ...manualTransactions];
