...
const CorteCajaContent = lazy(() => import('./components/corte-caja-content').then(module => ({ default: module.CorteCajaContent })));
const MovimientosCajaContent = lazy(() => import('./components/movimientos-caja-content').then(module => ({ default: module.MovimientosCajaContent })));


function CajaPageComponent({ tab }: { tab?: string }) {
  const defaultTab = tab || 'corte';
  ...
  const tabs = [
    { value: 'corte', label: 'Corte de Caja', content: (
        <CorteCajaContent 
            allSales={allSales}
    ...
    { value: 'movimientos', label: 'Movimientos de Caja', content: (
        <MovimientosCajaContent
            cashTransactions={cashTransactions}
        />
    )},
