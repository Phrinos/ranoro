// src/app/(app)/compras/page.tsx (o donde esté ComprasUnificadasPage)
"use client";
...
// ✅ client-only, sin React.lazy (evita conflictos con params/context readonly)
...
function ProveedoresTabContent({ suppliers }: { suppliers: Supplier[] }) {
  ...
  const handleRowClick = (supplierId: string) => {
    // navegación simple a la ficha del proveedor
    window.location.href = `/proveedores/${supplierId}`;
  };
