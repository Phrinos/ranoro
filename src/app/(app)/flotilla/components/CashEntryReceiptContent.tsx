...
export default function CashEntryReceiptContent({ entry, workshopInfo: customWorkshopInfo }: CashEntryReceiptContentProps) {
    ...
    >
      ...
      <div className="space-y-1">
          <div className="text-left">
            <span>Concepto:</span>
            <span className="font-semibold block">{entry.concept}</span>
          </div>
