      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4">
          {localFines.map((fine, index) => {
            ...
            return (
              <div key={fineId} className="flex flex-wrap items-center gap-2 p-2 border rounded-md">
          ...
          <Button type="button" variant="outline" onClick={handleAddFine} className="w-full border-dashed">
