...
const buildDefaults = (infraction?: Infraction, payment?: any | null): RegisterPaymentFormValues => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          {infraction && (
            <DialogDescription>
              Deuda total: {CURRENCY_FORMATTER.format(infraction.totalAmount)} | Deuda restante: {CURRENCY_FORMATTER.format(remainingAmount)}
            </DialogDescription>
          )}
        </DialogHeader>
