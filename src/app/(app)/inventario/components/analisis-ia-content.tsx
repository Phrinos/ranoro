...
export default function AnalisisIaContent({ inventoryItems }: AnalisisIaContentProps) {
  ...
  const handleRunAnalysis = useCallback(async () => {
    ...
    try {
      const inventoryForAI = inventoryItems.map(item => ({ id: item.id, name: item.name, sku: item.sku, quantity: item.quantity, lowStockThreshold: item.lowStockThreshold }));
