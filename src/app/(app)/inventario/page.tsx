...
const ProductosContent = lazy(() => import('./components/productos-content').then(module => ({ default: module.ProductosContent })));
const CategoriasContent = lazy(() => import('./components/categorias-content').then(module => ({ default: module.CategoriasContent })));
