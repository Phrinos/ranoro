...
import type { MonthlyFixedExpense, User } from "@/types";
...
export function EgresosContent({
  ...
  const percent = useMemo(() => {
    ...
    const p = Math.max(0, periodFactor);
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Detalle de gastos fijos configurados. Se muestra el total mensual y lo aplicado al periodo.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="border-t pt-4 space-y-2">
            <div className="flex justify-between items-center font-bold text-lg">
              <span>Total Mensual Configurado:</span>
              <span className="text-red-600">{formatCurrency(totalFixedAndPayrollConfigured)}</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-muted-foreground">Factor de aplicación al periodo:</span>
              <span className="font-medium">{percent}</span>
            </div>
            <div className="flex justify-between items-center font-semibold">
              <span>Gastos aplicados al periodo seleccionado:</span>
