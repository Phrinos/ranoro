                ...
                {fields.map((field, index) => (
                     <Card key={field.id} className="p-4 bg-muted/30">
                        ...
                        <div className="space-y-4">
                            ...
                            <PhotoUploader reportIndex={index} serviceId={serviceId} onUploadComplete={onPhotoUploaded} photosLength={(watch(`photoReports.${index}.photos`) || []).length} maxPhotos={10} disabled={isReadOnly} />
                        </div>
                     </Card>
                ))}
                {!isReadOnly && (
