...
export function ServiceForm({
  ...
  const dateLabel = (mode === 'service' && watchedStatus !== 'Agendado') ? 'Fecha de Recepción' : 'Fecha Agendada';
  const timeLabel = (mode === 'service' && watchedStatus !== 'Agendado') ? 'Hora de Recepción' : 'Hora Agendada';
