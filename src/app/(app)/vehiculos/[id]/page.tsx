                ...
                <Table>
                  ...
                  <TableBody>
                    {services.map(service => {
                        const serviceDate = service.serviceDate ? parseISO(service.serviceDate) : null;
                        const formattedDate = serviceDate && isValid(serviceDate) 
                            ? format(serviceDate, "dd MMM yyyy, HH:mm", { locale: es }) 
                            : 'N/A';
                        return (
