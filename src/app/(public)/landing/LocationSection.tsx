                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    <AnimatedDiv className="lg:col-span-5 flex flex-col justify-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 leading-tight">
                            Te esperamos en <br/><span className="text-primary text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/60">Ranoro Aguascalientes</span>
                        </h2>
                        ...
                        <div className="mt-10 space-y-6">
                            <Card className="border-none bg-slate-50 shadow-sm hover:shadow-md transition-shadow">
                                <CardContent className="p-4 flex gap-4 items-start">
                                    <div className="mt-1 rounded-full bg-white p-2 shadow-sm shrink-0 text-primary">
                            ...
                            <Card className="border-none bg-slate-50 shadow-sm hover:shadow-md transition-shadow">
                                <CardContent className="p-4 flex gap-4 items-start">
                                    <div className="mt-1 rounded-full bg-white p-2 shadow-sm shrink-0 text-amber-500">
                    ...
                    <AnimatedDiv className="lg:col-span-7 h-full min-h-[400px] lg:min-h-[600px]">
                        <div className="h-full w-full rounded-[2rem] overflow-hidden border border-slate-200 shadow-2xl relative group">
                            <div className="absolute inset-0 z-10 pointer-events-none ring-1 ring-inset ring-black/10 rounded-[2rem]" />
                             <iframe 
