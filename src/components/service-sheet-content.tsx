    ...
    const ServiceOrderContent = (
      <div className="flex flex-col min-h-full">
        ...
        <main className="flex-grow">
           <section className="grid grid-cols-3 gap-4 mb-2 text-xs">
          ...
          <section className="grid grid-cols-2 gap-2 mb-2 text-xs">
            ...
            {service.serviceType !== 'Cambio de Aceite' && (
              <div className="border-2 border-black p-2 rounded-md flex flex-col justify-between items-center min-h-[85px]">
                  <h3 className="font-bold uppercase text-center text-xs">AUTORIZO SERVICIOS</h3>
        ...
        <footer className="mt-auto pt-2 text-xs">
           <div className="grid grid-cols-2 gap-2 text-center mb-1">
               <div className="pt-2 flex flex-col justify-end">
                    <div className="min-h-[20px] flex-grow flex items-center justify-center">
                        {service.serviceAdvisorSignatureDataUrl && (
                            <div className="relative w-full h-full max-w-[100px]">
                                <Image src={normalizeDataUrl(service.serviceAdvisorSignatureDataUrl)} alt="Firma del asesor" width={100} height={20} style={{ objectFit: 'contain' }} unoptimized/>
                            </div>
                        )}
                    </div>
           ...
           {effectiveWorkshopInfo.fixedFooterText && (
            <div className="text-center mt-2 pt-2 border-t border-gray-200">
              <p className="text-[7px] text-muted-foreground whitespace-pre-wrap">{effectiveWorkshopInfo.fixedFooterText}</p>
            </div>
          )}
        </footer>
      </div>
