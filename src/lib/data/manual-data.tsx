...
export const manualSections = [
    ...
    { 
        ...
        content: ( <>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-2">
                <li><strong>Gestión de Usuarios:</strong> Crea, edita o elimina las cuentas de los miembros de tu equipo. Por seguridad, la asignación de contraseenas se gestiona desde la consola de Firebase.</li>
