export const PERMISSION_GROUPS = [
    ...
    },
    {
        ...
        permissions: [
            ...
            { id: 'finances:manage_manual_entries', label: 'Registrar/Editar Ingresos y Egresos Manuales' },
            { id: 'finances:delete_entries', label: 'Eliminar Registros del Reporte (Borrado Permanente)' },
