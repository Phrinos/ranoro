...
export const placeholderVehicles: Vehicle[] = [
  { id: 'V001', make: 'Toyota', model: 'Corolla', year: 2020, vin: 'ABC123XYZ789', ownerName: 'Juan Pérez', ownerContact: 'juan.perez@email.com', licensePlate: 'PQR-123' },
  { id: 'V002', make: 'Honda', model: 'Civic', year: 2019, vin: 'DEF456UVW456', ownerName: 'Maria López', ownerContact: 'maria.lopez@email.com', licensePlate: 'STU-456' },
  { id: 'V003', make: 'Ford', model: 'F-150', year: 2021, vin: 'GHI789RST123', ownerName: 'Carlos Sánchez', ownerContact: 'carlos.sanchez@email.com', licensePlate: 'VWX-789' },
];
